<?php
/*
Template Name: Home Page B - Nov 11
*/
?>
			...
			<div class="col-lg-11 col-lg-offset-1">
				<div class="row">
					<div class="col-sm-6 col-md-7 col-lg-7 orientation">
						<h1>Executive Transportation <br class="hidden-xs"> for Any Occasion</h1>
						<h2 class="hidden-xs">With over 26 years experience, Bauer’s IT delivers impeccable ground transportation solutions &amp; service - for every occasion, of any size or scope.</h2>
