		...
		<form id="intake_form" class="intake-form" action="https://www.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" method="post">
			...
			<fieldset>
				...
				<div class="form-group row supplementary">
					<div class="col-sm-6 left">
						<input readonly="true" type="text" id="pickup_date" name="00NE0000000cAFG" placeholder="Pick up date" class="form-control hasDatepicker" required="" value="" aria-required="true">
					</div>
					<div class="col-sm-6 right">
